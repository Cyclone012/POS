...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        LineBorder correctBorder = new LineBorder(Color.GRAY, 1);
        ...
        boolean usernameValid = inputUsername.length() > 0 && inputUsername.equals(username);
        boolean passwordValid = inputPassword.length() > 0 && inputPassword.equals(password);
        ...
        if (usernameValid && passwordValid) {
            ...
            if (!usernameValid) {
                blinkErrorBorders(UserName, usernameValid);
                blinkErrorBorders(Password, passwordValid);
                passwordValid = false;
            }
